...
<script type="text/javascript">
	...
	$(function(){
        ...
        //页面加载完毕后，加载关联的市场活动列表
		showActivityList();
		//为关联市场活动模态窗口的搜索框，绑定回车事件，查询并展现活动列表
                 ...
                 $.ajax({
                     ...
                     success:function (data) {
						...
						$.each(data,function (i,n) {
						 ...
						 $("#activitySerachBody").html(html)
                     }
                 })
				 //模态窗口敲击回车，会刷新当前页面，所以需要禁用刷新页面
				 return false;
			 }
        })
		...
		//实现全选效果
		$("#qx").click(function () {
			var $qx = $("input[name=xz]").prop("checked",this.checked);
        });
        $("#activitySerachBody").on("click",$("input[name=xz]"),function () {
        ...
        $("#bundBtn").click(function () {
			 ...
			 alert("选中不能为空")
				...
				//bund.do?cid=xxx&aid=xxx&aid=xxx
			     var param = "cid=${c.id}&";
    ...
    function showRemarkList() {
        ...
        $.ajax({
            ...
            html+='<font color="gray">线索</font> <font color="gray">-</font> <b>${c.fullname}</b> <small style="color: gray;"> '+(n.editFlag==0?n.createTime:n.editTime)+'由'+(n.editFlag==0?n.createBy:n.editBy)+'</small> <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">关联市场活动12</h4>
				</div>
				...
				<div class="modal-footer">
					...
					<button type="button" id="bundBtn">关联</button>
				</div>
			</div>
		</div>
	</div>
